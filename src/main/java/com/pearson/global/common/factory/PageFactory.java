...
import com.pearson.common.exception.automation.PageObjectNotRegisteredException;
import com.pearson.common.pageobject.PageObject;
import com.pearson.common.pageobject.PageObjectCreator;
import com.pearson.qglobal.common.pageobject.GenericPageObject;
	  ...
	  static private Map<String, PageFactory> instances = new HashMap<String, PageFactory>();
	    ...
	    public <T extends PageObject> T create(String url) throws Exception {
	        ...
	        if (pageObjects.containsKey(url)) {
	            ...
	            Log.log(driver).info("Creating Page Object: " + page + " " + page.getPageBuild());
	        } else {
	    ...
	    public PageObject createPageObject(String url) throws Exception {
	        ...
	        try {
	            ...
	            GenericPageObject genericPage = new GenericPageObject(driver);
	            genericPage.setPageUrl(url);
	            Log.log(driver).info("Created Page Object: " + genericPage + " " + genericPage.getPageBuild());
	            page = genericPage;
	        }
