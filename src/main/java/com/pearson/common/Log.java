...
import com.pearson.common.exception.LogInitializationException;
...
public class Log {
    ...
    public Log(String testName, WebDriver driver) throws Exception {
        try {
            ...
            String fullLogPath = FOLDER_PATH + CommonConstants.DIR_SEPARATOR.getValue() + "log_" + testName + ".log";
            ...
            fullLogPath = FOLDER_PATH + CommonConstants.DIR_SEPARATOR.getValue() + "error_log_" + testName + ".log";
    ...
    private static String initializeLogFolder() {
        String filePath = "";
        try {
        	String propertiesFolder = CommonConstants.CURRENT_DIR.getValue() + "properties";

            String propertiesFile = propertiesFolder 
                    + CommonConstants.DIR_SEPARATOR.getValue()
                    + "config.properties";
            ...
            if (filePath == null || filePath.isEmpty() 
                ...
                filePath = CommonConstants.CURRENT_DIR.getValue() 
                        + CommonConstants.DIR_SEPARATOR.getValue()
                        + "log"
                        + CommonConstants.DIR_SEPARATOR.getValue();
            }
            ...
            // if the directory does not exist, create it
     		File dirPath = new File(CommonConstants.CURRENT_DIR.getValue() + filePath);
    ...
    private static Logger initializeDefaultLogger() {
        try {
            Logger logger = Logger.getLogger("pearson.default");
     ...
     * {@link CompactLogFormatter}.
     * 
     * Refactored to include more options for logging as well
    ...
    public static class DefaultLogFormatter extends Formatter {
        ...
        public String format(LogRecord record) {
            ...
            StringBuilder buffer = new StringBuilder()
                ...
                .append(" ")
                .append(msg).append(CommonConstants.NEW_LINE.getValue());
